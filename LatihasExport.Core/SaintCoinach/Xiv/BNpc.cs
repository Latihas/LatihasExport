...
namespace SaintCoinach.Xiv {
    ...
    public class BNpc : ILocatable, IItemSource {
        ...
        public BNpcCollection Collection { get; private set; }

        /// <summary>
        /// Gets the locations of the current object.
        /// </summary>
        /// <value>The locations of the current object.</value>
        IEnumerable<ILocation> ILocatable.Locations { get { return Locations; } }
        ...
        #region Constructor
        public BNpc(BNpcCollection collection, Libra.BNpcName libra) {
            Collection = collection;
            _LibraRow = libra;
            Key = libra.Key;
            Base = collection.BaseSheet[(int)libra.BaseKey];
            Name = collection.NameSheet[(int)libra.NameKey];
        }
        #endregion
