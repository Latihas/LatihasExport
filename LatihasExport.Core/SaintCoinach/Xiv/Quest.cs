...
namespace SaintCoinach.Xiv {
    public class Quest : XivRow, IItemSource {
        ...
        public XivString Id { get { return AsString("Id"); } }
        ...
        public ImageFile SpecialIcon { get { return AsImage("Icon{Special}"); } }
        ...
        private ENpc[] BuildInvolvedENpcs() {
            ...
            if (Sheet.Collection.IsLibraAvailable) {
                ...
                var libraRows = Sheet.Collection.Libra.ENpcResident_Quest.Where(i => i.Quest_Key == Key);
