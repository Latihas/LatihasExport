...
namespace SaintCoinach.Xiv {
    public class ENpc : ILocatable, IQuantifiableXivString {
        ...
        public XivString Singular { get { return Resident.Singular; } }
        public XivString Plural { get { return Collection.Collection.ActiveLanguage == Language.Japanese ? Singular : Resident.Plural; } }
        public XivString Title { get { return Resident.Title; } }
        ...
        private ILocation[] BuildLocations() {
            ...
            var libraENpc = coll.Libra.ENpcResidents.FirstOrDefault(i => i.Key == Key);
            if (libraENpc == null)
                return levelLocations.ToArray();

            var locations = new List<ILocation>();
            locations.AddRange(levelLocations);
