...
namespace SaintCoinach.Xiv.Items {
    ...
    public abstract class Equipment : Item, IParameterObject {
        ...
        public ModelDefinition GetModel(int characterType, out ImcVariant variant) {
        ...
        public ModelDefinition GetModel(EquipSlot equipSlot, int characterType, out ImcVariant variant) {
