...
namespace SaintCoinach {
    ...
    public class ARealmReversed {
        ...
        private RelationDefinition ReadDefinition() {
            var versionPath = Path.Combine($"{Main.ROOTDIR}/Definitions", "game.ver");
            ...
            foreach (var sheetFileName in Directory.EnumerateFiles($"{Main.ROOTDIR}/Definitions", "*.json")) {
